...
<!--  sticky-->
    <header class="
        bg-gray-800
        shadow-lg  top-0 z-50
        text-emerald-800 py-6
       ">
      <nav class="container mx-auto px-4 lg:px-6">
        ...
        ">
          ...
          <div class="flex items-center mt-5 md:0 
            flex-col sm:flex-row gap-2  text-sm  sm:gap-4">
            <router-link
            ...
            >
              <span class=" md:0 block w-full py-2"> 
                  {{$route.path !== route.path ? '⭐': ''}} {{ route.name }}          </span>
